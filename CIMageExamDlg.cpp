...
// CIMageExamDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "CIMageExam.h"
#include "CIMageExamDlg.h"
...
CCIMageExamDlg::CCIMageExamDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CIMAGEEXAM_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CCIMageExamDlg::DoDataExchange(CDataExchange* pDX)
{
...
// CCIMageExamDlg 메시지 처리기

BOOL CCIMageExamDlg::OnInitDialog()
{
...
//  이 함수를 호출합니다.
HCURSOR CCIMageExamDlg::OnQueryDragIcon()
{
